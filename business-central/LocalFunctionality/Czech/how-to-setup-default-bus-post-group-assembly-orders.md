...
Funkcionalita usnadňuje práci s montážními zakázkami. V Nastavení montáže lze definovat Výchozí obecnou obchodní účto skupinu, jejíž hodnota se následně doplňuje do všech nově vytvořených montážních zakázek automaticky, není poté potřeba je manuálně doplňovat na každé montážní zakázce. Parametrizace tohoto pole ovlivňuje účtování montážní zakázky.

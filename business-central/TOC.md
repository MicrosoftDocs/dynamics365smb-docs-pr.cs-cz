...
##### [Překládání elektronických DPH a ICP prohlášení](LocalFunctionality/Netherlands/electronic-vat-and-icp-declarations.md)
#### Bankovnictví a platby
...
### Rusko
#### [Lokální funkcinoalita v ruské verzi](LocalFunctionality/Russia/russia-local-functionality.md)
#### Základ financí
##### [Přehled účetních schémat](LocalFunctionality/Russia/account-schedules-overview.md)
##### [Importování a exportování účetních sestav](LocalFunctionality/Russia/How-to-Import-and-Export-Account-Schedules.md)
##### [Definice rozšíření účetních schémet](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Extension.md)
##### [Definice účetní konstanty účetního schématu](LocalFunctionality/Russia/How-to-Define-an-Account-Schedule-Constant.md)
...
##### [Vložení vlastní onformace o prohlášení](LocalFunctionality/Russia/how-to-enter-custom-declarations-information.md)
...
##### [Vytváření dobropisů pro poplatek za dlouhodobý majetek](LocalFunctionality/Russia/How-to-Create-a-Credit-Memo-for-a-Fixed-Asset-Charge.md)
...
##### [Nákladní list](LocalFunctionality/Russia/bill-of-lading.md)
#### Lidské zdroje
...
##### [Nastavení SII pro sestavy DPH](LocalFunctionality/Spain/sii-setup.md)
...
##### [Eport výkazu DPH v textovém formátu](LocalFunctionality/Spain/how-to-export-vat-statements-in-text-format.md)
##### [Ekvivalentní platby](LocalFunctionality/Spain/equivalence-charges-ec-.md)
#### Bankovnictví a platby  
...
##### [Nastavení kódů operac](LocalFunctionality/Spain/how-to-set-up-operation-codes.md)
...
##### [Posílání dat prevence před podvody](LocalFunctionality/UnitedKingdom/fraud-prevention-data.md)
...
#### [Lokální funcionalita v americké verzi](LocalFunctionality/UnitedStates/united-states-local-functionality.md)
#### Daň
##### [Americká DPH](LocalFunctionality/UnitedStates/us-tax-setup.md)  
...
##### [Vykazování transakcí jako 1099 Liable v USA](LocalFunctionality/UnitedStates/tax-1099-changes.md)  
...
#### [Nastavení kalkulace a účtování pro daň z přidané hodnoty (DPH)](finance-setup-vat.md)
...
#### [Nastavení cen a slev](across-prices-and-discounts.md)
#### [Evidence speciálních prodejních cen a slev](sales-how-record-sales-price-discount-payment-agreements.md)
#### [Nastavení skupiny cen pro zákazníky](sales-how-to-set-up-customer-price-groups.md)
#### [Nastavení skupin slev pro zákazníky](sales-how-to-set-up-customer-discount-groups.md)
...
#### [Kongfigurace marketingového textu pomocí Copilot](enable-ai.md)
### Nastavení správy projektů
...
#### [astavení odpisování dlouhodobého majetku](fa-how-setup-depreciation.md)
#### [Definice metod odpisování](fa-depreciation-methods.md)
#### [Nastavení metod odepisování uživatelem](fa-how-setup-user-defined-depreciation-method.md)
...
#### [Nastavení skladu](warehouse-setup-warehouse.md)
#### [Přehled správa skladu](design-details-warehouse-management.md)
...
#### [Subdodavatelská výrobag](production-how-to-subcontract-manufacturing.md)
...
### Nastavení emailu
#### [Nastavení emailu](admin-how-setup-email.md)
#### Používání aplikace Outlook s aplikací Business Centralk
##### [Používání aplikace Business Central jako schránky doručené obchodní pošty aplikace Outlook](admin-outlook.md)
##### [Používejte Business Central pro došlou poštu aplikace Outlook](work-outlook-addin.md)
##### [Synchronizace s kontakty aplikace Microsoft Outlookk](admin-synchronize-outlook-contacts.md)
###### [Nastavení synchronizace kontaktů pro on-prem](admin-contact-sync-setup-onprem.md)
##### [Optimalizace aplikace Outlook](admin-outlook-optimize.md)
##### [Používání Business Central bez aplikace Outlook](admin-no-outlook.md)
##### [Nejčastější dotazy](ui-outlook-addin-faq.yml)
### Nastavení sestav
#### [Výběr sestavy pro dokumenty](across-report-selections.md)
### Nastavení workflow
...
#### [Export and Import workflow](across-how-to-export-and-import-workflows.md)
#### [Návod: Nastavení a použití workflow schvalování nákupů](walkthrough-setting-up-and-using-a-purchase-approval-workflow.md)
<!--Connectors-->
### Nastavení připojení
#### [Získejte Business Central rozšíření pro Excel](admin-deploy-excel-addin.md)
...
###### [Nastavení synchronizace kontaktů pro on-prem](admin-contact-sync-setup-onprem.md)
##### [Používání Business Central bez apliakce Outlook](admin-no-outlook.md)
#### Integrace Microsoft Teams
##### [Přehled](across-teams-overview.md)
##### [Správa integrace Teams](admin-teams-integration.md)
##### [Instalace aplikaci Business Central pro Teams](across-install-app-for-teams.md)
##### [Přístup k datům v aplikaci Teams bez licence Business Central](teams-access-with-m365-license.md)
##### [Hledejte Zákazníky, Dodavatele a Kontakty](across-search-contacts-teams.md)
##### [Přidejte záložku do kanálu nebo chatu Business Central](across-teams-tab.md)
...
## Soukromí
### [Soukromí (microsoft.com)](https://www.microsoft.com/trust-center/privacy)
## Dodržování předpisů
...
### Správa přístupu k Business Central
#### [Přehled](admin-access-overview.md)
#### [Řízení přístupu do služby Business Central pomocí skupin zabezpečení](ui-security-groups.md)
#### Přístup s licencemi Microsoft 365
##### [Přehled](admin-access-with-m365-license.md)
##### [Nastavte přístup k Microsoft 356 za pomocí licencí](admin-access-with-m365-license-setup.md)
##### [Tok přístupu uživatelů](admin-access-with-m365-license-flow.md)
##### [Nejčastější dotazy](admin-access-with-m365-license-faq.md)
##### [Řešení potíží](admin-access-with-m365-license-troubleshooting.md) 
...
#### [Správa uživatelských nastvení a preferencí](admin-manage-user-settings-preferences.md)
### Kontrola nad daty
#### [Klasiikace citlivosti dat](admin-classifying-data-sensitivity.md)
...
#### [Archivování dat](admin-archive-data.md)
#### [Definice zásad uchování údajů](admin-data-retention-policies.md)
#### [Správa šifrování dat](admin-manage-data-encryption.md)
#### [Zobrazení protokolů uzamčení databáze](admin-view-database-locks.md)
### [Nastavení tiskáren](ui-specify-printer-selection-reports.md)
### [Oznámení o ochraně osobních údajů Stav](privacy-notices-status.md)
...
### [Nastavení barevného indikátoru](admin-how-set-up-colored-indicator-on-cues.md)
...
#### [Rozšíření AMC Banking 365 Fundamentels](ui-extensions-amc-banking.md)
...
#### [Prodloužení prohlášení o službě](finance-how-setup-use-service-declaration.md)
#### [UK - GetADress.io UK Poštovní směrovací čísla](LocalFunctionality/UnitedKingdom/ui-extensions-getaddressio.md)
...
#### [Platební standard WorldPay](ui-extensions-worldpay-payments-standard.md)
...
### [nastavení uživatelksých účtů pro integraci s Microsoft Dataverse](admin-setting-up-integration-with-dynamics-sales.md)
...
### [Používejte Power Automate toky pro upozornění při změně entity v Dataverse](admin-power-automate-flow-dataverse.md)
## Snychronizujte Master Data napříč společnostmi
### [Připravte se na synchronizaci Master dat](admin-set-up-data-sync.md)
### [Správa synchronizace Master dat](admin-sync-master-data.md)
## Detaily návrhu
### [Přehled detailů návrhu aplikace](design-details-application-design.md)
### Detaily návrhu: Plánování dodávek
#### [Přehled plánování dodávek](design-details-supply-planning.md)
...
#### [Detaily návrhu: Aplikace zboží](design-details-item-application.md)  
#### [Detaily návrhu:Známé problémy vyrovnání zboží](design-details-inventory-zero-level-open-item-ledger-entries.md)  
#### [Detaily návrhu: Úprava nákladů](design-details-cost-adjustment.md)  
...
##### [Chybová zpráva "Zúčtovací datum není ve vašem rozsahu povolených zúčtovacích dat"](design-details-inventory-adjustment-value-entry-allowed-posting-dates.md)  
##### [Zúčtovací datum záznamu hodnoty úpravy v porovnání se zdrojovým záznamem](design-details-inventory-adjustment-value-entry-source-entry.md)  
...
#### [Detaily návrhu: Účtování zásob](design-details-inventory-posting.md)  
#### [Detaily návrhu: Zadávání výrobních objednávek](design-details-production-order-posting.md)  
...
#### [Detaily návru: Návrh sledování zboží](design-details-item-tracking-design.md)  
...
#### [Detaily návhru: Sledování zboží ve skladu](design-details-item-tracking-in-the-warehouse.md)
...
#### [Přehled pčtování řádku finančního deníku](design-details-general-journal-post-line-overview.md)  
...
### [Správa migrace na Cloud](/dynamics365/business-central/dev-itpro/administration/migration-manage?toc=/dynamics365/business-central/toc.json)
### [Migrace z Business Central On-Premise](/dynamics365/business-central/dev-itpro/administration/migrate-business-central-on-premises?toc=/dynamics365/business-central/toc.json)

...
1. Vyberte ikonu ![Hledat stránku nebo sestavu](media/ui-search/search_small.png "ikona Hledat stránku nebo sestavu"), vstupte do **Skupiny zdrojů** a poté vyberte související odkaz.
2. Zvolte akci **Nový**.
...
3. V okně **Kapacita zdroje** zadejte v poli **Zobrazit podle** délku období, například **Den**, která se zobrazí ve sloupcích na pevné záložce **Matice kapacity zdroje**.
...
6. V okně **Nastavení kapacity zdroje** vyplňte pole podle potřeby.
7. Vyberte akci **Aktualizovat kapacitu**. Okno **Kapacita zdroje** je aktualizováno o zadanou kapacitu.
8. Zavřete okno.
...
3. V okně **Pořizovací ceny zdrojů** podle potřeby vyplňte pole na řádku.  
4. Opakujte krok 3 pro každou alternativní pořizovací cenu zdroje, kterou chcete nastavit.

**Poznámka**. Chcete-li nastavit pořizovací ceny zdrojů, které se budou vztahovat na všechny zdroje a skupiny zdrojů, otevřete okno **Pořizovací ceny zdrojů** a vyplňte pole.
...
3. V okně **Prodejní ceny zdrojů** vyplňte podle potřeby pole na řádku.
